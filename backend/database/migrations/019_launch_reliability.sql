-- Fiabilidad mínima de lanzamiento: unicidad tenant/canales y doble-booking.
CREATE EXTENSION IF NOT EXISTS btree_gist;

-- Un usuario solo puede pertenecer a una clínica en el modelo actual.
CREATE UNIQUE INDEX IF NOT EXISTS clinica_usuarios_user_unique
  ON clinica_usuarios (user_id);

-- Un número Meta no puede enrutar hacia dos tenants.
...
-- Evita dos reservas simultáneas para el mismo profesional. La aplicación
