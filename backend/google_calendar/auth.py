...
def save_tokens(clinic_id: UUID, code: str, state: str) -> None:
    ...
    token_data = {
        ...
        # Sin expiry, Credentials.expired es siempre False y el token nunca se
        # renueva por adelantado: cada llamada se comía un 401 + refresh extra.
...
def get_credentials(clinic_id: UUID) -> Credentials:
    ...
    if token_data.get("expiry"):
        try:
            ...
            # google-auth compara expiry contra utcnow() naive.
            if expiry.tzinfo:
