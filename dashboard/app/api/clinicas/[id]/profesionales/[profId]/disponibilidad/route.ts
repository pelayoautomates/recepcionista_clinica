...
export async function GET(req: NextRequest, { params }: Ctx) {
  ...
  const res = await adminFetch(`/admin/clinicas/${id}/profesionales/${profId}/disponibilidad`, { noStore: true });
...
export async function PUT(req: NextRequest, { params }: Ctx) {
  ...
  const res = await adminFetch(`/admin/clinicas/${id}/profesionales/${profId}/disponibilidad`, {
    method: "PUT",
